...
class ControllerPaymentHipaymbway extends Controller {
    ...
    public function index() {
        ...
        $data['continue'] = $this->url->link('payment/hipaymbway/redirect');
        return $this->load->view('payment/hipaymbway', $data);
    }
    ...
    public function confirm() {
        ...
        $notificationUrl = $this->url->link('payment/hipaymbway/notification');
